      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          <div className="text-center">
            <h3 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-muted-foreground">
              Technologies I Work With
            </h3>
          </div>

          {/* Technology Grid - Professional Icons */}
          <div className="flex justify-center">
            <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 max-w-4xl">
              {/* React */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#61DAFB] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Next.js */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-foreground transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Node.js */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#339933] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Python */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#3776AB] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* AWS */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#FF9900] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Docker */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#2496ED] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Git */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#F05032] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* VS Code */}
              <div className="group relative aspect-square w-16 h-16 rounded-xl bg-muted/80 border border-border flex items-center justify-center transition-all duration-300 hover:bg-muted hover:border-primary/50 cursor-pointer">
                <svg className="w-8 h-8 text-[#007ACC] transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
